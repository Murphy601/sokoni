...
export const SUBCATEGORY_IMAGES = {
  ...
  "dairy-eggs": u("photo-1486297678162-eb2a19b0a32d", 302),
  ...
  "honey-bee": u("photo-1587049352846-4a222e784d38", 307),
  ...
  "wood-furniture": u("photo-1538688525198-9b88f6f53126", 331),
  "textiles-kitenge": u("photo-1558769132-cb1aea458c5e", 332),
  "home-decor": u("photo-1513519245088-0e12902e5a38", 333),
  "traditional-wear": u("photo-1594736797933-d0501ba2fe65", 334),
  "beadwork-jewelry": u("photo-1515562141207-7a88fb7ce338", 335),
  "pottery-ceramics": u("photo-1565193566173-7a0ee3dbe261", 336),
  "baskets-weaving": u("photo-1606768666853-403c90a981ad", 337),
  "leather-goods": u("photo-1473187983305-f615310e7daa", 338),
  metalwork: u("photo-1504328345606-18bbc8c9d7d1", 339),
  "carvings-sculpture": u("photo-1578926375605-eaf7559b1458", 340),
  "handmade-shoes": u("photo-1460353581641-37baddab0fa2", 341),
  "soap-candles": u("photo-1608571423902-eed4a5ad8108", 342),
  "crochet-knit": u("photo-1606923829579-0cb981a83e2e", 343),
  "custom-tailoring": u("photo-1556905055-8f358a7a47b2", 344),
  "local-art": u("photo-1578301978693-85fa9c0320b9", 345),
  "handmade-toys": u("photo-1558060370-d644479cb6f7", 346),
