#!/usr/bin/env node
/** Unit checks for Phase 4.3 listing studio (no Photoroom network calls). */
import {
  isStudioConfigured,
  removeBackground,
  previewStudioClean,
...
async function main() {
  ...
  console.log("OK: Phase 4.3 listing-studio helpers");
  console.log("  not_configured + mock success + api_failed paths");
}
