      ...
      .map((p) => {
        ...
        return {
          ...
          draft: {
            ...
            originalPriceKes: p.originalPriceKes || p.compareAtPrice || null,
            compareAtPrice: p.compareAtPrice || p.originalPriceKes || null,
            promo: p.promo && typeof p.promo === "object" ? p.promo : null,
          },
          promoActive: Boolean(p.promo?.active),
          originalPriceKes: p.compareAtPrice || p.originalPriceKes || null,
          compareAtPrice: p.compareAtPrice || p.originalPriceKes || null,
          imageUrl: p.imageUrl,
          images: p.images,
