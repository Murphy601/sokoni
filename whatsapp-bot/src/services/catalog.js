...
const QUERY_EXPANSIONS = {
  ...
  yoghurt: ["yoghurt", "yogurt", "dairy", "supermarket", "groceries"],
  yogurt: ["yoghurt", "yogurt", "dairy", "supermarket", "groceries"],
  milk: ["milk", "dairy", "supermarket", "groceries"],
  snack: ["snack", "snacks", "supermarket", "groceries"],
};
