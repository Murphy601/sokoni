...
function isTaxonomyQuery(lower) {
  return /\b(categor(y|ies)|subcategor(y|ies)|departments?|sections?|browse menu|what do you (sell|have)|what('s| is) (on |in )?sokoni|aesthetics?|vibes?|price tiers?|shop by)\b/i.test(
    lower
  );
}
